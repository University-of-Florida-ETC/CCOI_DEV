    ...
    <div class="container-fluid">
        <div class="container">
            <div id="session_go_back" class="row pt-3 pb-5 d-none">
                <div class="col">
                    <a class="underlined-btn" href="/observe"><span class="oi oi-arrow-thick-left mr-2"></span><span class="btn-text">Back to Session Select</span></a>
                </div>
            </div>
            <div class="row py-5">
                <div class="col-md-8">
                    <div class="row pr-md-5">
                        <div class="col-md-8 col-12">
                            <h1 class="red-font">C-COI Observation</h1>
                            <h5 id="coder_name"></h5>
                        </div>
                    ...
                    <div id="empty_sessions" class="row pt-3 d-none">
                        <span style="display: block; font-size: 80px; margin: 60px auto;" class="oi oi-inbox text-center" title="inbox" aria-hidden="true"></span>
                        <p class="text-center">You do not currently have any sessions. Click the Add Session button above to get started.</p>
                    </div>
                        ...
                        <div id="demo_help_box" class="row pt-3">
                            <div class="col">
                                <div class="md-boxed-content light-blue-background">
                                    <h4>C-COI Usage Instructions</h4>
                                    <ol id="demo_help_ol">
...
<!-- Reorder disabled, so draggable no longer imported-->
