...
<nav class="navbar navbar-expand-lg navbar-light px-md-5">
    <a class="navbar-brand" href="/">C-COI Nova</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="nav navbar-nav px-md-5">
            ...
            <li class="nav-item <?php echo ($page == "dashboard" ? "active" : "")?>">
                <a class="nav-link" href="/newestccoi/">New</a>
            </li>
        </ul>
        <ul class="nav navbar-nav ml-auto">
            <?php if(isset($_SESSION['pid']) === false) : ?>
                ...
                <a class="btn btn-gold my-2 mx-sm-2" href="/newestlogin" type="button">Log In</a>
            <?php endif; ?>
            <?php if(isset($_SESSION['pid'])) : ?>
                <a class="btn btn-gold my-2 mx-sm-2" href="/newestccoi/api/ccoi_logout" type="button">Log Out</a>
            <?php endif; ?>
        </ul>
    </div>
</nav>
