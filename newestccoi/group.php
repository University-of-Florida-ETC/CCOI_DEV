        ...
        <script>
                        ...
                        if (returnedInt == -1) {
                            ...
                            newEntry.innerHTML = `<div class="row">
                                                <div class="col-sm-9 col-12">
                                                    <a class="btn-link session-edit" href="/">${name}</a>
                                                </div>
                                                <div class="col-sm-3 col-12">
                                                    <a class="btn-link session-edit" href="/"><span class="oi oi-pencil px-2" title="Edit Session" aria-hidden="true"></span></a>
            ...
            function changeCurrentSession(newSessionID) {
                ...
                xmlHttp.onreadystatechange = function() {
                    ...
                    if(data){
                        if(data=="y"){
                            window.location.href = '<?= $devprodroot; ?>';
                        }
                        else {
