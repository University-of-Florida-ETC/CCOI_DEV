...
$includeroot= $_SERVER['DOCUMENT_ROOT'];			$devprodroot='/newccoi';			$serverroot=$_SERVER['SERVER_NAME'];				// this is PROD -- nothing for dev
...
<script language='javascript'>
	var derServer='https://{$serverroot}{$devprodroot}/api/';
